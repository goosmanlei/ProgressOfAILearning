...
- [11.6/12][Huggingface LLm Course](https://huggingface.co/learn/llm-course)：LLM结构、微调、推理、部署
...
- LangChain：LLM应用工程能力
    ...
    - [LangChain Docs - Getting Starts](https://docs.langchain.com/oss/python/langchain/quickstart)
